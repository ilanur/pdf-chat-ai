...
const QA_TEMPLATE = `You are an AI assistant for the EUI (European University Institute) located in Florence, Italy. Use the following pieces of context to answer the user question, in the language of the user.
